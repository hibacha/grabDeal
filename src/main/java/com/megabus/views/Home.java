...
public class Home {
	...
	private static final HomeContainer CONTAINER = PageFactory
			.initElements(BrowserDriver.getCurrentDriver(),
					HomeContainer.class);

	public static void selectDepartureState(String state) {
	...
	public static void selectDepartureCity(String city) {
	...
	public static void selectArrivalCity(String city) {
	...
	public static void selectDepartureDate(LocalDate date) {
	...
	public static void selectReturnDate(LocalDate date) {
